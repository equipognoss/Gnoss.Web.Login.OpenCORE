...
namespace Gnoss.Web.Login
{
    ...
    public class ControllerBaseLogin : Controller
    {
        ...
        private string mDominioPaginasAdministracion = "";
        ...
        /// <summary>
        /// Valida nombre, contrase�a y codigo de verificaci�n del usuario
        /// </summary>
        /// <param name="pNombre">Nombre del usuario</param>
        /// <param name="pContrasenia">Contrase�a de la cuenta</param>
        /// /// <param name="pCodigoVerificacion">C�digo verificaci�n para la validaci�n en 2 pasos</param>
        /// <returns>TRUE si usuario, contrase�a y codigo de verificaci�n  son correctos, FALSE en caso contrario</returns>
        [NonAction]
        ...
        public string ComprobarQueryString(string pQueryString, Guid pProyectoID, string pIdioma)
        {
            ...
            if (!string.IsNullOrEmpty(queryString))
            {
                ...
                if (queryParams["redirect"] != null)
                {
                    ...
                    string redirectValido = ComprobarRedirectValido(redirect, pProyectoID, pIdioma);
                    if (!redirect.Equals(redirectValido))
                    {
                        redirect = redirectValido;
                    }
                }
        ...
        /// <param name="pContrasenia">Contrase�a de la cuenta</param>
        /// <param name="pCodigoVerificacion">C�digo verificaci�n para la validaci�n en 2 pasos</param>
        /// <returns>TRUE si usuario y contrase�a y codigo de verificaci�n son correctos, FALSE en caso contrario</returns>
        [NonAction]
        ...
        private void AgregarDominio(string pDominio)
        {
            ...
            //establezco la validez de la cookie que ser� de 1 d�a
        ...
        /// <param name="pLogin">0 si el usuario se ha desconectado, 1 si est� logueado</param>
        /// <param name="pIdioma">Idioma con el que se conecta el usuario</param>
        /// <param name="pHashQuery">Diccionario de los par�metros de la petici�n actual</param>
        [NonAction]
        protected bool CrearCookieUsuarioActual(string pUsuarioID, string pLogin, string pIdioma, string pDominioAplicacion)
        {
            ...
            //establezco la validez inicial de la cookie que ser� de 1 d�a o indefinida si el usuario quiere mantener su sesi�n activa
            ...
            //A�ado la cookie al navegador con expiraci�n o si no de sesion
            if (!cookieSesion)
            {
            ...
            mLoggingService.GuardarLogError($"Dominio de la cookie: {usuarioLogueadoOptions.Domain}", mlogger);
        ...
        public UtilIdiomas UtilIdiomas
        {
            get
            {
                ...
                {
                    mUtilIdiomas = new UtilIdiomas("es", mLoggingService, mEntityContext, mConfigService, mRedisCacheWrapper, mLoggerFactory.CreateLogger<UtilIdiomas>(), mLoggerFactory);
                }
                return mUtilIdiomas;
            }
        }
        ...
        /// <summary>
        /// Obtiene la URL de la aplicaci�n principal para este servicio de login
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el dominio de esta aplicaci�n
        /// </summary>
