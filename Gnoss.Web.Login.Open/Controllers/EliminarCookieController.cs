...
namespace Gnoss.Web.Login
{
    ...
    /// <summary>
    /// P�gina que elimina las cookies de todos los dominios en los que el usuario ha estado
    /// </summary>
    [Controller]
    [Route("[controller]")]
    public class EliminarCookieController : ControllerBaseLogin
    {
        ...
        public ActionResult Index()
        {
            ...
            if (!Request.Headers.ContainsKey("eliminar") && !Request.Query.ContainsKey("eliminar"))
            {
                ...
                if (Request.Cookies.ContainsKey(cookieEnvioKey) || Request.Headers.ContainsKey("nuevoEnvio"))
                {
                    ...
                    //El usuario se acaba de conectar, si habia estado en otros dominios, elimino su sesi�n
        ...
        /// <summary>
        /// M�todo que elimina las cookies de todos los dominios
        /// </summary>
        [NonAction]
        private List<string> EliminarCookieRestoDominios(string pDominio)
        {
            ...
            {
                //Recorre todos los dominios que hay en la cookie dominios y accede a la p�gina eliminarCookie.aspx de cada uno de ellos, que elimina sus cookies
